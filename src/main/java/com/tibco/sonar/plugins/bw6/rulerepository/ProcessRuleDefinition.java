...
public final class ProcessRuleDefinition implements RulesDefinition {
    ...
    private static final Class<?>[] check = {
		...
		com.tibco.sonar.plugins.bw6.check.process.ActivityNamingConventionCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.SchemaFilenameValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.DEV4SubstvarValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.UATSubstvarValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.ITSubstvarValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.STSubstvarValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.PTSubstvarValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.AMSubstvarValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.ProjectNameValidationCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.GlobalVariableNamingConventionCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.SharedVariableNamingConventionCheck.class,
		com.tibco.sonar.plugins.bw6.check.project.ProcessesFolderStructureCheck.class,		
    ...
    private static final AbstractCheck[] checkList = {
		...
		new com.tibco.sonar.plugins.bw6.check.process.ActivityNamingConventionCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.SchemaFilenameValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.DEV4SubstvarValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.UATSubstvarValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.ITSubstvarValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.STSubstvarValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.PTSubstvarValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.AMSubstvarValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.ProjectNameValidationCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.GlobalVariableNamingConventionCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.SharedVariableNamingConventionCheck(),
		new com.tibco.sonar.plugins.bw6.check.project.ProcessesFolderStructureCheck(),
