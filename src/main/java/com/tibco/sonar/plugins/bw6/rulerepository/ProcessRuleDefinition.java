...
public final class ProcessRuleDefinition implements RulesDefinition {
    ...
    private static final Class<?>[] check = {
		...
		com.tibco.sonar.plugins.bw6.check.project.VariableNamingConventionCheck.class,
    ...
    private static final AbstractCheck[] checkList = {
		...
		new com.tibco.sonar.plugins.bw6.check.project.VariableNamingConventionCheck(),
